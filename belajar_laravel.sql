...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2021 at 05:22 AM
...
-- Error reading data for table belajar_laravel.buku: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `belajar_laravel`.`buku`' at line 1
...
(1, 17, '2021-09-21', '2021-09-26'),
(2, 17, '2021-09-21', '2021-09-26'),
(3, 17, '2021-09-21', '2021-09-26');
...
(17, 'Muhammad Rafa Athallah', '2005-11-15', 'Malang', 'L', 'rafa', '25f9e794323b453', 3);
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
